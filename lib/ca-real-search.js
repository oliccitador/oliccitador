...
// Chaves carregadas do .env.local (Node environment)
const GOOGLE_API_KEY = process.env.GOOGLE_API_KEY;
// Usando a chave _2 se disponível, senão a padrão
const SEARCH_API_KEY = process.env.GOOGLE_SEARCH_API_KEY_2 || process.env.GOOGLE_SEARCH_API_KEY;
