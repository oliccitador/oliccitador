...
3. REGRA DA QUERY SEMÂNTICA LIMPA:
   ...
   **REGRA ESPECIAL PARA ELETRÔNICOS E ELETRODOMÉSTICOS:**
   - Use VALORES ESPECÍFICOS nunca ranges ("8GB" não "8GB+", "15.6 polegadas" não "superior a 14")
   ...
   - Para ELETRODOMÉSTICOS: inclua capacidade/potência exata (ex: "12000 BTU" não "superior a 10000")
   - Traduza specs técnicas: "núcleos 4-8" → "Intel Core i5", "sistema proprietário" → "Windows", "superior a 14" → "15.6 polegadas"
   - Exemplo CORRETO: "Notebook 15.6 polegadas touchscreen Intel Core i5 8GB RAM SSD 512GB webcam Windows teclado ABNT2"
   - Exemplo ERRADO: "Notebook Tela Touchscreen, RAM 8GB+, SSD 500GB+"
