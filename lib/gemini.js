...
export async function analyzeWithFlow(description, ca, catmat) {
  ...
  try {
    ...
    // Priority for query_semantica_limpa: Flow > Gemini
    return {
      ...flowResult,
      detetive_de_codigos: geminiAnalysis.detetive_de_codigos,
      regra_edital_gemeo: geminiAnalysis.regra_edital_gemeo,
      query_semantica_limpa: flowResult.query_semantica_limpa || geminiAnalysis.query_semantica_limpa || description.substring(0, 50),
